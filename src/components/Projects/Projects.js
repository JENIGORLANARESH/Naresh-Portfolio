      ...
      <div id="Projects" className="projects">
        <div className="row justify-content-center d-flex">
          <p className="text-center text-success mt-5">
            Some Samples From My Recent Project
          </p>
          ...
          <div className="marquee mb-5 d-flex flex-column flex-sm-row justify-content-evenly ">
            <div className="project-1 col-sm-5 order-sm-1 Shadow ">
              <h3>LiveNews</h3>
              <p>
                This application provides users with real-time news updates from
                various sources.
              </p>
              <a
                href="https://livenewsproject.onrender.com/india"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img src={livenews} alt="livenews" />
              </a>
            </div>
            <div className="project-2 col-sm-5 order-sm-2 Shadow">
              <h3>Weather360</h3>
              <p>
                Weather360 is a weather forecast application built using
                Node.js, Express.js, EJS, CSS, Bootsrap and a weather API.
              </p>
              <a
                href="https://weather360-f8m6.onrender.com/vijayawada"
                target="_blank"
                rel="noopener noreferrer"
              >
                {" "}
                <img src={weather360} alt="weather360" />
              </a>
            </div>
          </div>
        </div>
