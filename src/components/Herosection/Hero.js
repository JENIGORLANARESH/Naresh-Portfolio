      ...
      <div className="row ">
        ...
        <div className="right col-sm-6 align-items-center justify-content-center d-flex ">
          ...
          <div className="details align-items-center justify-content-center align-items-center text-center">
              <h4 className="text-success mb-3"><strong>Hi all 👋 I'm </strong></h4>
              ...
              <div className="d-inline-block">
                <ul className="text-center h4 list-unstyled">
                  ...
                  <li><strong>A Big Data Enthusiast</strong></li>
              ...
              A passionate Full Stack Software Developer having an experience of building Web
                applications with JavaScript / Reactjs / Nodejs  and
                some other cool libraries and frameworks.
              </p>
              <a className="btn btn-success btn-lg border-0 primary-btn-shadow" href="#Contact" role="button" >Contact Me</a>
          </div>
