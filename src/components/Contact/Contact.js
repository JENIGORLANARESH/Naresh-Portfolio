            ...
            <div className='col-sm-6'>
                <div className='bg-light box10 mb-5 rounded-4 custom-shadow'>
                    ...
                    <ul className='text-center pb-4 Icons'>
                        ...
                        <li className="d-inline-block p-sm-3"><a href="https://www.instagram.com/"><i className="fa-brands fa-instagram fa-3x i-insta text-danger"></i></a></li>
                        <li className="d-inline-block p-sm-3"><a href="mailto:nareshjenigorla@gmail.com"><i className="fa-solid fa-envelope fa-3x bg-light text-success"></i></a></li>
