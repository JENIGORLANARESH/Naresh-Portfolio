        ...
        <div id="About">
            <div  className=" pb-3 container-fluid">
                ...
                <div className="about-details rounded row mt-sm-5 mb-sm-5 justify-content-center d-flex">
                    <p class="text-center text-success mt-5">Some Lines About My Self</p>
                    <h1 class="text-center">ABOUT ME</h1>
                    <hr className="bg-success hr-break" ></hr>
                    <p class="text-center">This section shows you brief info about me.</p>

                    <div className="row  d-flex">
                        <div className="mt-sm-3 pb-sm-0 mb-sm-3 bg-light rounded-3  custom-shadow d-flex align-items-center">
                            <div className="col-sm-6 float-start text-center rounded">
                            ...
                            <div className="col-sm-6 float-sm-end text-center rounded d-flex  align-items-center justify-content-center">
